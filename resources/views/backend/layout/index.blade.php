                ...
                <li class="nav-header">
                    <div class="navbar-minimalize">
                        ...
                        <div class="profile-element" style="width: 64px;height: 64px;">
                            <img alt="image" class="img-circle img100per"  style="width: 100%;" src="{{asset('backend/img/profile_small.jpg')}}"/>
                        </div>
                    </div>
        ...
        <div class="row content-tabs">
            ...
            <nav class="page-tabs J_menuTabs">
                <div class="page-tabs-content">
                    <a href="javascript:;" class="active J_menuTab" data-id="{{route('backend.base')}}">首页</a>
                </div>
            </nav>
            ...
            <div class="btn-group roll-nav roll-right">
                ...
                <a href="{{route('backend.logout')}}" class="roll-nav roll-right J_tabExit"><i class="fa fa-sign-out"></i> 退出</a>
        </div>
        <div class="row J_mainContent" id="content-main">
            <iframe class="J_iframe" name="iframe" width="100%" height="100%" src="{{route('backend.base')}}"
                    frameborder="0" data-id="{{ route('backend.base') }}" seamless></iframe>
        </div>
    </div>
    <!--右侧部分结束-->
